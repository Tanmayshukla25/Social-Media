    ...
    >
      ...
      >
        ...
        <div className="flex justify-center gap-6 mb-6">
          <button className="text-3xl hover:scale-110 transition"><FcGoogle /></button>
          <button className="text-3xl text-blue-600 hover:scale-110 transition"><FaLinkedin /></button>
          <button className="text-3xl text-white hover:scale-110 transition"><ImGithub /></button>
        </div>

        <h3 className="text-center text-sm mb-6 text-white/80">or Login with email</h3>
        ...
        <Link to="/register">  <span className="text-cyan-400 font-semibold underline cursor-pointer">
            Register
          </span></Link>
        </p>
      </div>
